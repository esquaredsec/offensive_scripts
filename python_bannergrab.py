...
parser = OptionParser()
parser.add_option("t", dest="iprange",help="target IP range, i.e. 10.11.1.1-25")
parser.add_option("-p", dest="port",default="80",help="port, default=80")
parser.add_option("-d", dest="delay",default="1",help="delay (in seconds), default=1 seconds")
